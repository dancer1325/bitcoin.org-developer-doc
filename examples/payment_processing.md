...
* | Bitcoin Core version 0.18,
  * ⚠️deprecated⚠️
    * replace by [BIP70](https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki) URI’s 
* allows
  * request payment
    * -- via -- using a “bitcoin:” URI /
      * extended
...
* Merchants should transition away from `BIP70 <https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki>`__ to more secure options such as `BIP21 <https://github.com/bitcoin/bips/blob/master/bip-0021.mediawiki>`__
* Merchants should never require `BIP70 <https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki>`__ payments and should provide `BIP21 <https://github.com/bitcoin/bips/blob/master/bip-0021.mediawiki>`__ fallbacks.
